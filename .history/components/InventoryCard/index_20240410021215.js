...
export default function InventoryCard({
    ...
    return (
        <>
            <fieldset className={styles.fieldset} height={height2} width={width2} style={{ color: color, backgroundColor: bgColor, boxShadow: boxShadow, borderRadius:  borderRadius, border: border}}>
