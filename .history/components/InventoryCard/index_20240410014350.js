...
export default function InventoryCard({
    ...
    return (
        <>
            <fieldset className={styles.fieldset} height={cardHeight} width={cardHeight} style={{color: color, backgroundColor: bgColor, boxShadow: boxShadow,  borderRadius:  borderRadius, border: border}}>
