...
export default function InventoryCard({
    ...
    return (
        <>
            <fieldset className={styles.fieldset} height={height} width={width} style={{ color: color, backgroundColor: bgColor, boxShadow: boxShadow, borderRadius:  borderRadius, border: border}}>
