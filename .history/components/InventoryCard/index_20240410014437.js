...
export default function InventoryCard({
    ...
    return (
        <>
            <fieldset className={styles.fieldset} height={cardHeight} width={cardWidth} style={{color: color, backgroundColor: bgColor, boxShadow: boxShadow,  borderRadius:  borderRadius, border: border}}>
