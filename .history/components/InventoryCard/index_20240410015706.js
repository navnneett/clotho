...
export default function InventoryCard({
    ...
    return (
        <>
            <fieldset className={styles.fieldset} style={{ height: cardHeight, width: cardWidth, color: color, backgroundColor: bgColor, boxShadow: boxShadow,  borderRadius:  borderRadius, border: border}}>
