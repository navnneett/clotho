        ...
        <>
            <div className={styles.container}>
                <div className={styles.home}>
                    <Link href='/'>
                    <svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg" style={{backgroundColor: bgColorHome}}>
                ...
                <div className={styles.inventory}>
                    <Link href='/'>
                    <svg width="41" height="42" viewBox="0 0 41 42" fill="none" xmlns="http://www.w3.org/2000/svg" style={{backgroundColor: bgColorInventory}}>
                ...
                <div className={styles.plus}>
                    <Link href='/'>
                    <svg width="81" height="37" viewBox="0 0 81 37" fill="none" xmlns="http://www.w3.org/2000/svg" style={{backgroundColor: bgColorPlus}}>
                ...
                <div className={styles.collection}>
                    <Link href='/'>
                    <svg width="37" height="41" viewBox="0 0 37 41" fill="none" xmlns="http://www.w3.org/2000/svg" style={{backgroundColor: bgColorCollection}}>
                ...
                <div className={styles.community}>
                    <Link href='/'>
                    <svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg" style={{backgroundColor: bgColorCommunity}}>
