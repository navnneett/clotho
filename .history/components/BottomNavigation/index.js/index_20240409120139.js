    ...
    return (
        <>
            <div className={styles.container}>
                ...
                <div className={styles.plus} style={{backgroundColor: bgColorPlus}}>
                    <Link href='/Plus/Plus'>
                ...
                <div className={styles.collection} style={{backgroundColor: bgColorCollection}}>
                ...
                <div className={styles.community}  style={{backgroundColor: bgColorCommunity}}>
