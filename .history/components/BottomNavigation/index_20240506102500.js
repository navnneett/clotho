            ...
            <div className={styles.container}>
                ...
                <div className={styles.collection} style={{backgroundColor: bgColorCollection, borderRadius: borderStyle, width: iconWidth, height: iconHeight}}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="42" viewBox="0 0 44 42" fill="none" tabIndex={4}>
                        <path d="M22 39L19.1 36.3384C8.8 26.9221 2 20.7117 2 13.0899C2 6.87956 6.84 2 13 2C16.48 2 19.82 3.63324 22 6.21417C24.18 3.63324 27.52 2 31 2C37.16 2 42 6.87956 42 13.0899C42 20.7117 35.2 26.9221 24.9 36.3586L22 39Z" stroke="#8229E0" strokeWidth="4"/>
                    </svg>
                    </Link>
                </div>
