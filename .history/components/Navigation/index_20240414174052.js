...
export default function Navigation({ toggleMenu }) {
    ...
    return (
        <div style={{ width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 100 }}>
        <div className={styles.sideNav} style={{ position: 'fixed', width: '300px', height: '100%', backgroundColor: 'white', transform: `translateX(${isOpen ? '0%' : '-100%'})`, transition: 'transform 0.3s ease-in-out' }} ref={navigationRef}>
