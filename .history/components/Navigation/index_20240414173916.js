...
export default function Navigation({ toggleMenu }) {
    ...
    return (
        ...
        <div className={styles.sideNav} style={{ position: 'absolute', top: 0, left: 0, width: '300px', height: '100%', backgroundColor: 'white', transform: `translateX(${isOpen ? '0%' : '-100%'})`, transition: 'transform 0.3s ease-in-out' }} ref={navigationRef}>
