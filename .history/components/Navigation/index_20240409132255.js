...
export default function Navigation() {
    ...
    const backgroundColor = click ? 'var(--button-highlight-light)' : inherit;
    ...
    return(
        <div className={styles.sideNav}>
            ...
            <Link href="/Calendar/Calendar" style={{textDecoration: 'none', color: 'var(--black)', cursor: 'pointer', backgroundColor}} onClick={isClick}>
                <MenuItem title="Calendar"/>
            </Link>
            <MenuItem title="Posts"/>
            <Link href="/ThriftStore/ThriftStore" style={{textDecoration: 'none', color: 'var(--black)', cursor: 'pointer', backgroundColor}} onClick={isClick}>
