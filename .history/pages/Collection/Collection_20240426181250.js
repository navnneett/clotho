                    ...
                    <div className={styles.contentContainer}>
                        ...
                        {color ? (
                            ...
                            <Button onClick={isClick} title="All" padding={"10px 15px 15px 15px"} borderRadius="11px" width={100} height={40} fontSize="var(--open-sans-small)" margin="5px" />
                                ...
                                <ButtonTwo title="Party" height={40} margin="5px" onClick={() => findItems("T")} />
                                <ButtonTwo title="Office" height={40} margin="5px" onClick={() => findItems("B")} />
                                <ButtonTwo title="Casual" height={40} margin="5px" onClick={() => findItems("J")} />
