    ...
    return(
        <>
            <div className={styles.questionAnalysis}>
                ...
                <h3 className={styles.title} id="space">Approach to Fashion</h3>
                ...
                <h3 className={styles.title} id="space">Priority When Shopping for Clothes</h3>
                ...
                <h3 className={styles.title} id="space">Types of Events for Dressing Up</h3>
                ...
                <h3 className={styles.title} id="space">Wardrobe Organization</h3>
                ...
                <h3 className={styles.title} id="space">Challenges in Choosing Outfits</h3>
