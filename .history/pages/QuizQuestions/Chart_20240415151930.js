...
export default function Chart({ resultType }) {
    ...
    const dataA = [
        ...
        { name: "Vintage", uv: 15, pv: 15, fill: "var(--chart-light-purple)" },
    ...
    const dataB = [
        ...
        { name: "Gothic", uv: 20, pv: 20, fill: "var(--chart-light-purple)" },
    ...
    const dataC = [
        ...
        { name: "Romantic", uv: 15, pv: 15, fill: "var(--chart-light-purple)" },
    ...
    const dataD = [
        ...
        { name: "Retro", uv: 20, pv: 20, fill: "var(--chart-light-purple)" },
