    ...
    return(
        <>
            ...
            <div>
                ...
                <ul>
                    <li className={styles.bulletPoint}>Invest in timeless pieces: tailored blazers, crisp button-down shirts, and well-fitted denim jeans</li>
                    <li>Choose comfortable dress-ups: relaxed-fit trousers, oversized knitwear, and flowy midi dresses</li>
                    <li>Prepare versatile essentials: striped tops, camel coats, and black ankle boots</li>
                    <li>Incorporate personalized touches: custom monogramming, and handmade jewelry</li>
                </ul>
            </div>
        </>
    )
