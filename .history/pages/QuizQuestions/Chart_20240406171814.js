    ...
    return(
        <>
            ...
            <div>
                ...
                <p>Invest in timeless pieces such as tailored blazers, crisp button-down shirts, and well-fitted denim jeans</p>
                <p>Choose comfortable dress-ups like relaxed-fit trousers, oversized knitwear, and flowy midi dresses</p>
                <p>Prepare versatile essentials</p>
            </div>
        </>
    )
}