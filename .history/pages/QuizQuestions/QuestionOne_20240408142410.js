...
export default function QuestionOne() {
    ...
    return (
        <>
                    ...
                    <div className={styles.contentContainer}>
                        <div className={styles.optionContainer}>
                            ...
                            <div className={styles.optionRowOne}>
                                <ButtonTwo onClick={() => handleAnswerSelection('A')} title="Timeless and Classic" className={styles.optionRowInnerOne} tabIndex={2}/>
                                <ButtonTwo onClick={() => handleAnswerSelection('B')} title="Bold and Trendy" className={styles.optionRowInnerTwo} tabIndex={3}/>
                            </div>
            ...
            {currentQuestion === 2 && (
                <QuestionTwo onNextQuestion={handleNextQuestion} onAnswerSelection={questionToAnswer} />
            )}

            {currentQuestion === 3 && (
                <QuestionThree onNextQuestion={handleNextQuestion} onAnswerSelection={questionToAnswer} />
            )}

            {currentQuestion === 4 && (
                <QuestionFour onNextQuestion={handleNextQuestion} onAnswerSelection={questionToAnswer} />
            )}

            {currentQuestion === 5 && (
                <QuestionFive onNextQuestion={handleNextQuestion} onAnswerSelection={questionToAnswer} />
            )}
        </>
    );
}
