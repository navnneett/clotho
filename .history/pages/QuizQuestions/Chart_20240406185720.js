        ...
        <>
            <div className={styles.questionAnalysis}>
                ...
                {isClient ? 
                    ...
                    <Legend iconSize={10} width={120} height={140} margin={{ top: 20, right: 30, left: 20, bottom: 5 }} padding={{ top: 10, right: 20, left: 10, bottom: 10 }} layout='vertical' verticalAlign='middle' align="right"/>
                    <Tooltip/>
                    </RadialBarChart> : <></>}
