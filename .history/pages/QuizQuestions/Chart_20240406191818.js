    ...
    return(
        <>
            <div className={styles.questionAnalysis}>
                ...
                <h3 className={styles.title}>Approach to Fashion</h3>
                ...
                <h3 className={styles.title}>Priority When Shopping for Clothes</h3>
                ...
                <h3 className={styles.title}>Types of Events for Dressing Up</h3>
                ...
                <h3 className={styles.title}>Wardrobe Organization</h3>
                ...
                <h3 className={styles.title}>Challenges in Choosing Outfits</h3>
            ...
            <div className={styles.questionAnalysis}>
                <h2 className={styles.title}>Fashion Trend Recommendations</h2>
                <ul analysisContent>
