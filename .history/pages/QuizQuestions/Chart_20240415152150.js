...
export default function Chart({ resultType }) {
    ...
    const dataA = [
        ...
        { name: "Vintage", uv: 15, pv: 15, fill: "var(--chart-color-light-purple)" },
    ...
    const dataB = [
        ...
        { name: "Gothic", uv: 20, pv: 20, fill: "var(--chart-color-light-purple)" },
    ...
    const dataC = [
        ...
        { name: "Romantic", uv: 15, pv: 15, fill: "var(--chart-color-light-purple)" },
    ...
    const dataD = [
        ...
        { name: "Retro", uv: 20, pv: 20, fill: "var(--chart-color-light-purple)" },
                    ...
                    <div className={styles.chart}>
                        ...
                        <ResponsiveContainer width={400} height={300}>
                            ...
                            >
                                ...
                                <RadialBar minAngle={15} label={{ fill: 'var(--button-linear-light)', position: 'insideStart' }} background clockWise={true} dataKey='Prentage' />
