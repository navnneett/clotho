...
export default function Chart() {
    ...
    const dataB = [
        ...
        { name: "Tren Setter", uv: 30, pv: 30, fill: "var(--chart-color-blue)" },
        { name: "Electric", uv: 15, pv: 15, fill: "var(--chart-color-purple)" }
    ];

    // Determine which data array to use based on the result type
    const dataToShow = resultType === "A" ? dataA : dataB;
