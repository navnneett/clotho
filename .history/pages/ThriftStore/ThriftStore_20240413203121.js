...
export default function ThriftStore() {
    ...
    const handleSearch = async () => {
        try {
            const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(searchQuery)}&key=9596f078c7a0457fb5fe18c0190bfa42`);
            if (!response.ok) {
