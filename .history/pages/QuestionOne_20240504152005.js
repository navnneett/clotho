                    ...
                    <div className={styles.contentContainer}>
                        <div className={styles.optionContainer}>
                            ...
                            <div className={styles.optionRowOne}>
                                <ButtonTwo onClick={() => handleAnswerSelection('A')} title="Timeless and Classic" className={selectedOption === "A" ? styles.selected : styles.option} tabIndex={2}/>
                                <ButtonTwo onClick={() => handleAnswerSelection('B')} title="Bold and Trendy" className={selectedOption === "B" ? styles.selected : styles.option} tabIndex={3}/>
                            </div>
