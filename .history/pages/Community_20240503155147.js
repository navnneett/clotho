            ...
            <main className={styles.main}>
                <div className={styles.pageTitle}>
                    ...
                    <svg width="24" height="27" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19.3333 8.93333C19.3333 7.0945 18.5607 5.33098 17.1855 4.03073C15.8102 2.73047 13.9449 2 12 2C10.0551 2 8.18982 2.73047 6.81455 4.03073C5.43928 5.33098 4.66667 7.0945 4.66667 8.93333C4.66667 17.0222 1 20.6667 1 20.6667H23C23 20.6667 19.3333 17.0222 19.3333 8.93333Z" stroke="#17191F" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M14.75 24.6667C14.4705 25.0722 14.0694 25.4088 13.5868 25.6428C13.1041 25.8768 12.557 26 12 26C11.443 26 10.8959 25.8768 10.4132 25.6428C9.9306 25.4088 9.52947 25.0722 9.25 24.6667" stroke="#17191F" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round"/>
