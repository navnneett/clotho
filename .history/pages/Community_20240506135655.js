...
export default function Community() {
    ...
    const url = `https://gnews.io/api/v4/search?q=${type}&&from=${date}&sortBy=${sortBy}&apiKey=${apiKey}`;
                ...
                <div className={styles.mainContainer}>
                    <div className={styles.newContainer}>
                        ...
                        }}>
                        {
                            ...
                            data.articles.filter(article => article.title.toLowerCase().includes('fashion')).map((articles, index) => {
                                return(
                                    <div>
