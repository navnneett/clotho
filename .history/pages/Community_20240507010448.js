...
export default function Community() {
    ...
    const url = `https://api.thenewsapi.com/v1/news/all?api_token=${apiKey}&language=en&limit=3&q=${type}`;
    ...
    const toggleNotification = () => {
        ...
        console.log("Notification state toggled. isNotificationOpen:", !isNotificationOpen);
        console.log("New state value:", isNotificationOpen);
    };
    
    return (
        <>
        <Head title="Community" description="Community page of Clotho." />
                ...
                <div className={styles.mainContainer}>
                    <div className={styles.newContainer}>
                        ...
                        }}>
                        {
                            ...
                            data.articles.filter(article => article.thread.title.toLowerCase().includes('fashion')).map((d, index) => {
                                return(
                                    <div>
