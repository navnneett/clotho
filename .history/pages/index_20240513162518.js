...
export default function Home() {
  ...
  useEffect(() => {
    if (playQuizSound) {
      ...
      audio.play();
      setPlayQuizSound(false); // Reset the state
    }
  }, [playQuizSound]);
    ...
    <>
      ...
      <main className={`${styles.main} ${styles.box}`}>
        <div className={styles.pageTitle}>
          <div onClick={toggleMenu} className={styles.menuIcon} tabIndex={1}>
          ...
          <div className={styles.logo}>
            <Image src="/images/black-logo.png" alt="App Logo Black" width={105} height={70} />      
          </div>
        ...
        <div className={styles.helloUser}>
            <div className={styles.userHolder} tabIndex={2}>
              <div className={styles.userInfo}>
                <Image src="/images/user-image.png" alt="User Image" width={90} height={90} />
              </div>
              <div className={styles.userText}>
                <p className={styles.welcome}>Welcome back,</p>
                <p className={styles.welcomeUser}>Ana</p>
              </div>
            </div>
        </div>

        <div className={styles.takeQuiz}>
          <p className={styles.quizTitle}>Discover your Ideal Style!</p>
          <p className={styles.quizText}>Take this quiz to uncover your unique fashion sense and find out your ideal style.</p>
            <div className={styles.quizRectangle}>
              <div className={styles.quizRectangleLine}></div>
              <div className={styles.takeQuizMascotContainer}> 
                <Image 
                  src="/images/take-quiz.gif"
                  alt="Mascot in various accessories"
                  width={370}
                  height={370}
