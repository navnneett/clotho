                        ...
                        <div>
                            {color ? (
                                <div className={styles.chipButton}>
                                    <ButtonTwo title="All" width={150} height={40} margin="5px" onClick={() => findItems("ALL")} />
                                </div>
                            ) : 
                                (
                                <Button onClick={isClick} title="All" width={150} height={40} borderRadius="10px" fontSize="var(--open-sans-small)" margin="5px" />
                            )}
                        </div>
                        <div>
