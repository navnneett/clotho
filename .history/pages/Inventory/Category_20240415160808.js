...
export default function Category() {
    ...
    const findItems = (title) => {
        setSelectedItems(title.toLowerCase())
    }
        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    ...
                    <ButtonTwo title="Shoes" height={40} width={100} margin="5px" onClick={() => findItems("shoes")}>Shoes</ButtonTwo>
                    <ButtonTwo title="Tops" height={40} width={100} margin="5px" onClick={() => findItems("tops")}>Tops</ButtonTwo>
                    <ButtonTwo title="Bottoms" height={40} width={100} margin="5px" onClick={() => findItems("bottoms")}>Bottoms</ButtonTwo>
                    <ButtonTwo title="Jackets" height={40} width={100} margin="5px" onClick={() => findItems("jackets")}>Jackets</ButtonTwo>
                    <ButtonTwo title="Accessories" height={40} width={100} margin="5px" onClick={() => findItems("accessories")}>Accessories</ButtonTwo>
                </div>
                ...
                <div className={styles.cards}>
                    {selectedCards && selectedCards.map((photo, index) => (
                        selectedItems === "all" ? (
                            ...
                            selectedItems === photo.title.slice(0,2).toLocaleLowerCase() && (
                                <CategoryCard 
                                key={index}
                                photoId={photo.id}
                                className={styles.items}
