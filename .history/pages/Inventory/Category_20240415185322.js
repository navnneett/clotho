            ...
            <div className={styles.contentContainer}>
                ...
                <div className={`${styles.chip} ${styles.carouselContainer}`}>
                    <Carousel responsive={responsive}>
                        <div>
                            {color ? (
                                <ButtonTwo title="All" margin="5px" onClick={() => findItems("ALL")} />
                            ) : 
                                (
                                <Button onClick={isClick} title="All" borderRadius="10px" fontSize="var(--open-sans-small)" margin="5px" />
                            )}
                        </div>
                        <div>
                            <ButtonTwo title="Shoes" margin="5px" onClick={() => findItems("S")} />
                        </div>
                        <div>
                            <ButtonTwo title="Tops" margin="5px" onClick={() => findItems("T")} />
                        </div>
                        <div>
                            <ButtonTwo title="Bottoms" margin="5px" onClick={() => findItems("B")} />
                        </div>
                        <div>
                            <ButtonTwo title="Jackets" margin="5px" onClick={() => findItems("J")} />
                        </div>
                        <div>
                            <ButtonTwo title="Accessories" margin="5px" onClick={() => findItems("A")} />
                        </div>
                    </Carousel>
                    {color ? (
                            <ButtonTwo title="All" margin="5px" onClick={() => findItems("ALL")} />
