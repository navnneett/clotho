        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    ...
                    <ButtonTwo title="Shoes" height={40} width={100} margin="5px" onClick={() => findItems("sho")}>Shoes</ButtonTwo>
                    <ButtonTwo title="Tops" height={40} width={100} margin="5px" onClick={() => findItems("top")}>Tops</ButtonTwo>
                    <ButtonTwo title="Bottoms" height={40} width={100} margin="5px" onClick={() => findItems("bot")}>Bottoms</ButtonTwo>
                    <ButtonTwo title="Jackets" height={40} width={100} margin="5px" onClick={() => findItems("jac")}>Jackets</ButtonTwo>
                    <ButtonTwo title="Accessories" height={40} width={100} margin="5px" onClick={() => findItems("acc")}>Accessories</ButtonTwo>
                </div>
