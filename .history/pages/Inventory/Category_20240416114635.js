                ...
                <div className={styles.mainContainer} >
                    <div className={styles.contentContainer}>
                        <div className={`${styles.chip} ${styles.carouselContainer}`}>
                                {isClick ? (<Button title="All" height={40} borderRadius="11px" margin='0, 5px' margin="5px" onClick={() => findItems("ALL")}/>): (<ButtonTwo title="All" width={100} height={40} margin="5px" onClick={() => findItems("ALL")}/>)}
