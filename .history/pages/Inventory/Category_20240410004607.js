        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    ...
                    <ButtonTwo className={styles.buttons} title="Tops" height={40} width={100}>Tops</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title="Bottoms" height={40} width={100}>Bottoms</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title="Jackets" height={40} width={100}>Jackets</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title="Accessories" height={40} width={100}>Accessories</ButtonTwo>
                </div>
