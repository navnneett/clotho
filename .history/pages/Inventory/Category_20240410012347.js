...
export default function Category() {
    ...
    const [color, setColor] = useState('var(--button-highlight-light)');
    const isClick = (backgroundColor) => {
        if(backgroundColor == 'var(--button-highlight-light)') {
            setColor(color === 'var(--button-highlight-light)' ? 'linear-gradient(var(--button-linear-light))' : 'var(--button-highlight-light)');
        }
    }
        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    <Button onClick={isClick} title="All" height={40} width={100} bgColor="var(--button-highlight-light)" borderRadius="10px" fontSize="var(--open-sans-small)" margin="5px">All</Button>
