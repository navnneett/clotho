                ...
                <div className={styles.mainContainer} >
                    <div className={styles.contentContainer}>
                        <div className={`${styles.chip} ${styles.carouselContainer}`}>
                                {isColor ? (<ButtonTwo title="All" width={100} height={40} margin="5px" bgColor="var()"onClick={() => findItems("ALL")}/>): (<ButtonTwo title="All" width={100} height={40} margin="5px" onClick={() => findItems("ALL")}/>)}
