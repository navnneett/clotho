        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    ...
                    <Button className={styles.buttons}>T-shirts</Button>
                    <Button className={styles.buttons}>Jeans</Button>
                    <Button className={styles.buttons}>Jackets</Button>
                    <Button className={styles.buttons}>Jackets</Button>
                    <Button className={styles.buttons}>Accessories</Button>
                </div>
