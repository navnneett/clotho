        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    ...
                    <ButtonTwo className={styles.buttons} title="T-shirt">T-shirts</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title="Jeans">Jeans</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title="Jacket">Jackets</ButtonTwo>
                    <ButtonTwo className={styles.buttons} title=">Jackets</Button>
                    <ButtonTwo className={styles.buttons}>Accessories</ButtonTwo>
                </div>
