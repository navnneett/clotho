        ...
        <div className={styles.mainContainer} >
            <div className={styles.contentContainer}>
                ...
                <div className={styles.chip}>
                    <Button className={styles.button} title="All" height={40} width={100} borderRadius="10px" fontSize="var(--open-sans-small)">All</Button>
                    <ButtonTwo className={styles.button} title="Shoes" height={40} width={100}>Shoes</ButtonTwo>
                    <Button className={styles.button}>T-shirts</Button>
                    <Button className={styles.button}>Jeans</Button>
