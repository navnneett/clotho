                    ...
                    <div className={styles.contentContainer}>
                        ...
                        {color ? (
                            ...
                            <Button onClick={isClick} title="All" padding={"10px 15px 15px 15px"} borderRadius="11px" width={100} height={40} fontSize="var(--open-sans-small)" margin="5px" />
                                ...
                                <ButtonTwo title="Shoes" height={40} margin="5px" style={{ backgroundColor: isClick ? "var(--button-highlight-light)" : "linear-gradient(var(--button-linear-light))" }} onClick={() => findItems("S")} />
