    ...
    return (
        <div className={styles.mainContainer}>
            ...
            <div className={styles.contentContainer}>
                    ...
                    <h1 className={styles.pageTitle}>Styles which suits you the best!</h1> 
                    </div>
                    ...
                    <div className={styles.mainContents}>
                        ...
                        <h3 className={styles.analysisTitle}>Events to Dress Up</h3>
                        ...
                        <h3 className={styles.analysisTitle}>Choosing Outfits</h3>
                        <p>Finding the right fit and balancing comfort with fashion, suggests comfortable wearing.</p>
                    </div>
                </div>
                <BottomNavigation 
