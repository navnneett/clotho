...
export default function QuestionTwo({ onNextQuestion }) {
    ...
    const handleAnswerSelection = (answer) => {
        setSelectedAnswer(answer); // This should update the state correctly
    };

    const handleNextQuestion = () => {
        if (onNextQuestion) {
            onNextQuestion(selectedAnswer); // Pass the selected answer to the next question
        }
    };
            ...
            <div className={styles.contentContainer}>
                ...
                <div className={styles.optionRowOne}>
                    <ButtonTwo 
                        ...
                        className={selectedAnswer === 'A' ? styles.selected : ''} // Conditionally applying the 'selected' class
                    />
                    <ButtonTwo 
