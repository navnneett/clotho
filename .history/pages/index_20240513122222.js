    ...
    <>
      ...
      <main className={`${styles.main} ${styles.box}`}>
        ...
        <div className={styles.takeQuiz}>
          ...
          <p className={styles.quizText} tabIndex={3}>Take this quiz to uncover your unique fashion sense and find out your ideal style.</p>
        ...
        <div className={styles.contentContainer} tabIndex={4}>
