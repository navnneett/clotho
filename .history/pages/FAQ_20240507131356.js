        ...
        <Head title="FAQ" description="Frequently Asked Quesions." />
            ...
            <main className={`${styles.main} ${styles.box}`}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.smallSection}>
                        <p className={styles.question}>What security measures are in place to protect my data?</p>
                        <p className={styles.answer}>
                            Users might want to know the process of adding new clothing items to their inventory, 
                            including uploading photos, entering descriptions, and specifying details like size, 
                            color, and quantity.
                        </p>
                    </div>
