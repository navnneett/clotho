            ...
            <main className={`${styles.main} ${styles.box}`}>
                ...
                <div className={styles.content}>
                    <div className={styles.smallSection}>
                        <p className={styles.question}>How to redo the styling quiz?</p>
                        <p className={styles.answer}>
                            From the side menu, there is an option called "Take the quiz", after chosing this 
                            you will be able to redo the quiz whenever you want.
                        </p>
                    </div>

                    <div className={styles.smallSection}>
                        <p className={styles.question}>Can I organize my inventory into categories?</p>
                        <p className={styles.answer}>
                            Yes, you can.
                        </p>
                    </div>
                    ...
                    <div className={styles.smallSection}>
                        <p className={styles.question}>Can I change my infomation?</p>
                        <p className={styles.answer}>
                            Yes, you can. Going to the "Profile" page, you will be able to edit your personal information 
                            after clicking "Edit profile" button. Changing and clicking to the "Save change" button after 
                            that to update your new information.
                        </p>
                    </div>

                    <div className={styles.smallSection}>
                        <p className={styles.question}>How can I locate thrift stores in my area for donating clothing?</p>
                        <p className={styles.answer}>
                            By accessing the "Thrift Store" page from the side menu, you can find the nearby thrift stores 
                            after providing your ZIP code/ postal code.
                        </p>
                    </div>

                    <div className={styles.smallSection}>
                        <p className={styles.question}>Who created this app?</p>
                        <p className={styles.answer}>
                            This app is made by a group of three students from Degital Design and Development program of BCIT. 
                            The group members include Samantha Yan, Navneet Aulakh, and Sandy Ly.
                        </p>
                    </div>
                </div>
